    ...
    <main style={{ minHeight: '100vh', padding: 24 }}>
      <div style={{ maxWidth: 1100, margin: '0 auto' }}>
        ...
        <p style={{ marginTop: 0, color: '#b6c2df' }}>
          Build a session by selecting exercises and configuring reps, hold times, rest, and posture.
        </p>
                  ...
                  <div key={step.id} style={cardStyle}>
                    ...
                    >
                      ...
                      <SelectField<RequiredPosture>
                        ...
                        onChange={(v) => updateStep(step.id, { requiredPosture: v })}
                      />
                      <SelectField<StartMode>
                        label="Start mode"
                        ...
                        onChange={(v) => updateStep(step.id, { startMode: v })}
                      />
                    </div>
                  </div>
                );
