// lib/exercises/catalog/raiseLeftHand.ts

import { ExerciseDefinition } from "../exerciseTypes";

export const raiseLeftHandExercise: ExerciseDefinition = {
  id: "raise-left-hand",
  slug: "raise-left-hand",
  title: "Raise Left Hand",
  description: "Lift your left arm upward and lower it back down with control.",
  category: "upper_body",
  sideMode: "left",
  ...
  coachingRules: [
    {
      code: "lift_higher",
      priority: 100,
      message: "Raise your left arm a little higher.",
    },
    {
    ...
    },
    {
      ...
      priority: 80,
      message: "Try to keep your left elbow straighter.",
    },
    {
      code: "hold_position",
      priority: 70,
